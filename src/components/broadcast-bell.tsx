...
export function BroadcastBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 sm:right-[-40px] md:right-0 top-12 z-50 w-[calc(100vw-32px)] sm:w-[380px] max-h-[calc(100vh-100px)] sm:max-h-[520px] rounded-2xl bg-white border border-[#FFEDD5] shadow-2xl shadow-orange-900/15 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
          {/* Header */}
